...
title: DON26TZ01 STTR Release 1 - Sensing to Measure and Validate Corrosion in Naval Systems
...
verified: 2026-05-23
content_sha256: 0031c0c6cac33a7e6506188662e6d600ecb115029deb81a68eb8781351a55c81
...
| 5/19/26 | Q. |
Will there be any Government Furnished Property/Equipment on the Phase I? E.g. coupons, sensors, etc. |
A. |
The government will not be supplying any equipment. |
|
| 5/19/26 | Q. |
Are we required to buy sensors during Phase I? If not, how are we expected to accomplish the required testing? If so, how do we budget for sensors that won't be identified until the Phase I is underway? (Not only do the costs vary, including some too expensive for a Phase I budget, but also the Phase I proposal requires detailed backup of our material pricing.) |
A. |
Please review the topic objective. The objective of this topic is to devise a corrosion sensor and suite of corrosion sensors that currently seemingly do not currently exist. One has to develop the sensor concept and convince to review panel at the end of Phase I that it is workable to sense corrosion , corrosion rates, that are currently unavailable. |
