...
title: Revisiting the Relationship Between Economic and Sea Power
url: https://www.csis.org/analysis/revisiting-relationship-between-economic-and-sea-power
publisher: csis-org
publication_date: 
captured: 2026-05-26
...
verified: 2026-05-26
content_sha256: ae75e67fb611473e5e8442e889994351ab4f688f652538b62dd9f443e2c4fdf6
...
The United States is in a maritime crisis brought on by generational neglect of the inseparable relationship between economics and sea power. While the nation remains a global trading and naval power, the commercial and industrial base that helps convert economic strength into sea power has declined. Shipyards are unable to produce on time, repair capacity is constrained, mariners are scarce, order books are uncertain, and unit costs remain too high to scale. The result is a trap: Weak demand discourages investment, underinvestment keeps capacity (especially in the workforce) low, low capacity raises cost and time, and high cost suppresses demand. The decline of U.S. commercial shipping has created a market failure that produces strategic risk given the growing naval competition between the United States and China.
...
**MAP and SHIPS as Competitive Industrial Strategy**
...
- create predictable demand through cargo rules, federal procurement, and a Strategic Commercial Fleet;
- provide durable financing through a Maritime Security Trust Fund;
- reduce cost through commercial standards, design discipline, modularity, digital engineering, and scale;
- connect commercial shipping to defense logistics and sea lines of communication; and
- use allied shipbuilders to accelerate learning, import production systems, and create competition inside the U.S. market.
...
**Add a statutory cost-down mandate.**Congress should require annual reporting on cost per compensated gross ton, construction cycle time, shipyard throughput, repair throughput, workforce productivity, schedule variance, private-capital leverage, supplier diversification, and U.S.-to-allied price parity. MAP already calls for rebuilding capacity at scale. The missing layer is a public scoreboard that tracks whether costs are falling.**Make the Maritime Security Trust Fund performance gated.**Awards should be competed and tied to private capital match, delivery milestones, cost reduction, workforce growth, supplier diversification, and yard modernization. Chronic nonperformance should trigger clawbacks. Strong performance should earn larger order books and faster financing.**Make the Strategic Commercial Fleet contestable.**Fleet entry should be competed by vessel class, route utility, military usefulness, price, delivery schedule, and commercial viability. Studies suggest the Strategic Commercial Fleet can create a consistent demand signal and reduce taxpayer support through competitive bidding. That logic only works if incumbency does not become entitlement.**Use allied shipbuilders as productivity accelerators.**The United States should work with allies and partners to erode China’s market dominance and expand shipbuilding capacity in the United States and key partner countries. Allied investment in the U.S. maritime industrial base should go hand-in-hand with sharing best practices in shipyard production, bringing in advanced technology such as digital yard management tools and robotics, workforce training, supplier localization, and measurable productivity gains. There should be a new arsenal of democracies (plural) that collectively convert economic power into sea power as a foundation of deterrence.**Sequence cargo preference and China-linked fees with real capacity.**MAP financing would rely partly on port fees connected to China-built ships (though fees were paused for one year in November 2025 after diplomatic and trade tensions). Demand creation that outruns capacity can raise costs before it expands supply.**Enforce design maturity of federal purchases of commercial-grade ships (such as military sealift command vessels) before construction.**Shifting designs is a major issue in naval shipbuilding, as the Government Accountability Office’s warning on shipbuilding delays and the Constellation-class frigate showed, and federal adoption of best practices from the commercial sector should become a standing rule for MAP implementation. The United States needs more ships, but immature designs consume yard capacity and compound delay. Congress should also require that these mature designs come with digital twins to support long-term efficiency gains.**Run an annual stress test on sea lines of communication.**The Maritime Administration, the Navy, Transportation Command, the Coast Guard, the Department of Homeland Security, the U.S. Trade Representative, and key allies should assess whether the United States can move military cargo, sustain critical imports, repair damaged vessels, crew ships, and keep priority ports open during crisis. The output should include a classified readiness assessment and an unclassified scorecard that can support government programs, legislation, and efforts to align commercial interests.
