...
**FACT:** The DON FY27 Press Brief includes a separate $0.6 billion line item for Contested Logistics, justified explicitly because *"adversaries will target supply lines, ports, and communications"* [s.2026-05-26-don-fy27-press-brief].

**Assessment:** The Contested Logistics line item is a physical-logistics-resilience program (spares, fuel distribution, lift capability, port-security assets), not a training-scenario program. The brief cites this line as background environment for the corrected-scope hypothesis, not as a direct procurement signal for the gamified decision-rehearsal product.
...
**FACT:** A press release on the Commander, U.S. Pacific Fleet site (cpf.navy.mil) covers USS Ashland's completion of the Ship Wartime Repair and Maintenance Exercise in the Philippines, with embarked Marines from I Marine Expeditionary Force, operating under Task Force Ashland in U.S. 7th Fleet [s.2026-05-26-uss-ashland-completes-ship-war].

**Assessment:** SRF-JRMC, USINDOPACOM, and COMPACFLT also surfaced parallel landing pages and press releases around the same exercise during the 2026-05-26 source-finding pass, but those pages are not separately ingested as primary sources in this draft. The parallel-release pattern is an analyst observation across customer-org landing pages, not a quoted source claim. If a v1.0 of this brief depends on the parallel-release pattern as evidence of cross-organization coordination, the corresponding SRF-JRMC, USINDOPACOM, and COMPACFLT pages should be ingested as their own sources.
...
**FACT:** A Defense Visual Information Distribution Service (DVIDS) news release covered USS Iwo Jima's damage controlmen training the crew in simulated casualty scenarios — flooding, fire, gas leak, and hull rupture — for shipboard damage control [s.2026-05-26-dvids-news-dont-give-up-the-sh].

**Assessment:** This source is shipboard organic damage control at the deck-plate level — the layer the 2026-05-26 scope correction moved away from. It is included here only as evidence that the Navy publicly catalogs damage-related training content. The corrected-scope product targets the assessment-team and repair-team operational-decision layer above the deck-plate damage-control layer, not the deck-plate layer itself. The contrast is doing analytical work, not the source content.
...
**FACT:** The Center for International Maritime Security (CIMSEC) published *"If the U.S. Navy Can't Repair Ships in Peacetime, How Will It Do So in War?"* — observing that shortfalls already exist in planned peacetime maintenance and that the Navy lacks the salvage capability to conduct battle-damage repair in a major conflict [s.2026-05-26-if-the-u-s-navy-cant-repair-sh].
...
**FACT:** A Shipyard Infrastructure Optimization Program (SIOP) brief hosted on the Pacific Naval Facilities Engineering Command site (pacific.navfac.navy.mil) documents infrastructure investments across the four public naval shipyards, with Puget Sound Naval Shipyard and Subordinate Bases (PSNS-SBS) specifics for the small-business outreach audience; the slide deck identifies SIOP Program Executive Mark Edelson, PEO Industrial Infrastructure, and Program Manager CAPT Luke Greene, PMO 555 [s.2026-05-26-siop-brief-psns-sbs-2025-1].
...
**FACT:** The FY27 Department of War budget justification book, under USMC JNTC Project 774, describes the Marine Air-Ground Task Force (MAGTF) Tactical Warfare Simulation as *"developing an exercise planning, design, implementation, execution, and control tool ... enabling exercise designers the ability to rapidly build new scenarios and incorporate human geography elements into the training scenarios"* [s.2026-05-26-justification-book].

**Assessment:** The cited capability description is the Project 774 narrative of existing scope, not a new FY27 funding line; the FY27 funding for Project 774 itself is small and overlaps with prior-year continuations.

**FACT:** The same FY27 Department of War justification book references the joint exercise design and control tool — *"design and development of a joint exercise design and control tool ... providing exercise planning, design and control within various joint simulation constructs"* — under Project 774 (USMC JNTC), with FY2025 funding of $0.268 million and zero FY2026 / FY2027 funding [s.2026-05-26-justification-book].
...
**FACT:** CACI NSS, LLC holds a $194 million task order (PIID 47QFCA20F0002) for *"Plans, Operations, Logistics, Engagement, Training, Exercise, and Assessment Support to AFRICOM"* — Department of Defense / Department of the Army funder, awarded via the General Services Administration Federal Acquisition Service against parent IDC GS00Q14OADU121 [s.2026-05-26-the-purpose-of-this-award-is-t].

**Assessment:** Parent IDC GS00Q14OADU121 is GSA OASIS Pool 1, a governmentwide Indefinite-Delivery / Indefinite-Quantity contract that any federal customer (including any Navy fleet command) can issue task orders against directly. The CACI NSS, LLC subsidiary additionally holds NITAAC CIO-SP3 (Information Technology services) and a GSA Multiple Award Schedule (GS-35F-349CA), each a governmentwide vehicle with the same direct-task-order access path.
...
**FACT:** Axient LLC holds a Test, Exercise and Wargames Support contract with total obligation $233,761,711 (~$233.76M) — Missile Defense Agency funder, place of performance Huntsville, Alabama [s.2026-05-26-test-exercise-and-wargames-sup].
...
**FACT:** Acting Secretary of the Navy Hung Cao signed the cover of the Department of the Navy FY27 President's Budget Press Brief dated 28 April 2026 [s.2026-05-26-don-fy27-press-brief].

**Assessment:** The brief separately references Cao's signature on the foreword of the Navy's May 2026 Shipbuilding Plan; that document is not yet ingested as a primary source in `01_sources/`. The Shipbuilding Plan claim should be cited to its own primary source before it earns FACT status; until then it remains in the working-summary context only.
...
**FACT:** Caudle's HASC testimony frames the FY27 posture around four named priorities — "Battle Ready Sailors – Quality of Service and Warfighter Competency," "Total Force Readiness – Infrastructure, Maintenance, Operations, and Spares," "Maritime Kill Chain – Command and Control, Counter-Targeting, and Long-Range Fires," and "Golden Fleet Initiative – Future Force Design and Scalable Combat Power" — with the second priority (Total Force Readiness) explicitly covering Infrastructure, Maintenance, Operations, and Spares [s.2026-05-26-2026-05-14-caudle-testimony].
...
**FACT:** A Shipyard Infrastructure Optimization Program brief hosted on the Pacific Naval Facilities Engineering Command site (pacific.navfac.navy.mil) documents infrastructure investments across the four public naval shipyards, with Puget Sound Naval Shipyard and Subordinate Bases (PSNS-SBS) specifics for the small-business outreach audience [s.2026-05-26-siop-brief-psns-sbs-2025-1].

**FACT:** The DON FY27 Press Brief funds six SIOP construction projects in FY27 [s.2026-05-26-don-fy27-press-brief].

**Assessment:** SIOP doctrine and historical SIOP project listings show the six construction projects distribute across the four public shipyards; the press brief does not enumerate the per-shipyard allocation for FY27 specifically.
...
**FACT:** A press release on the Commander, U.S. Pacific Fleet site (cpf.navy.mil) reports that USS Ashland and embarked Marines from I Marine Expeditionary Force, operating under Task Force Ashland in U.S. 7th Fleet, conducted the Ship Wartime Repair and Maintenance Exercise in the Philippines, working shoulder-to-shoulder with Philippine allies to conduct complex repairs while keeping the ship ready for regional contingencies [s.2026-05-26-uss-ashland-completes-ship-war].

**Assessment:** The exercise is part of the Navy's Ship Wartime Repair and Maintenance Exercise program (referred to as SWaRMEx or SWARMEX in some analytical literature); the cited press release uses the full descriptive name rather than the program acronym. SRF-JRMC, USINDOPACOM, and COMPACFLT participated in or surfaced parallel coverage; those pages are not separately ingested.

**FACT:** Naval News identified Philippine Naval Sea Systems Command participation in the USS Ashland wartime-repair rehearsal at Cebu South Port; the Naval News coverage uses the descriptive event name and does not use the SWARMEX program acronym [s.2026-05-26-u-s-navy-rehearses-wartime-rep].
...
**FACT:** The Optimized Fleet Response Plan is governed by joint instruction COMUSFLTFORCOM/COMPACFLT INST 3000.15B / COMUSNAVEUR/COMUSNAVAFINST 300.15, dated 20 October 2020 [s.2026-05-26-fix-the-navys-expeditionary-re].

**FACT:** A press release hosted on the Commander, U.S. Pacific Fleet site (cpf.navy.mil) reports that USS Ashland's wartime repair and maintenance exercise was conducted alongside Philippine allies and U.S. 7th Fleet [s.2026-05-26-uss-ashland-completes-ship-war].
...
**FACT:** CACI NSS, LLC holds a $194 million task order for *"Plans, Operations, Logistics, Engagement, Training, Exercise, and Assessment Support to AFRICOM."* Awarded via GSA Federal Acquisition Service against parent IDC GS00Q14OADU121 [s.2026-05-26-the-purpose-of-this-award-is-t].
...
**FACT:** Axient LLC holds a Test, Exercise and Wargames Support contract with total obligation $233,761,711 (~$233.76M) — MDA funder [s.2026-05-26-test-exercise-and-wargames-sup].

**Assessment:** Because the customer is the Missile Defense Agency, the practical scope of the Test, Exercise and Wargames Support work-type is missile-defense testing and operator training. The source title names the work-type but not the customer-specific application.
...
**Assessment (Master Scenario Events List incumbent set, candidate names source-grounded at adjacent customers).** The operator-allowlisted canonical large-services incumbents per `_entity-allowlist.yaml` are Booz Allen Hamilton, SAIC, Leidos, and HII Mission Technologies. Three of the four are now source-grounded at adjacent Navy training, wargame, and Indo-Pacific defense-services customers — SAIC holds a $120 million Navy Tactical Training War Game Support contract awarded by Naval Supply Systems Command in August 2024 [s.2026-05-28-u-s-navy-awards-saic-120-milli]; HII Mission Technologies was selected in August 2025 for a Navy training multiple-award IDIQ with a $267 million ceiling, plus a separate $75 million task order for systems engineering of Aegis live-virtual-constructive training networks in October 2024 [s.2026-05-28-hii-selected-for-u-s-navy-trai]; and Booz Allen Hamilton publishes a defense-services portfolio for the Indo-Pacific that names theater-wide digital-twin development, accelerated-readiness training, and joint-all-domain support — direct adjacency to the corrected-scope work-type at the right theater [s.2026-05-28-building-defense-technology-fo]. The actual subset active specifically at FLTFORCOM N7, COMPACFLT N7, INDOPACOM J7, and the SRF-JRMC wartime-readiness cell remains NOT source-grounded in vault content; the new evidence confirms credible candidate-incumbent status at the work-type and Navy customer level but does not confirm fleet-command N7 contracts. Specialized exercise-design sub-tier players exist alongside the named primes and are also not yet source-grounded. The §7 leg 5 falsifier reasoning frames the customer-access pathway feasibility question at the candidate-set level; the specific incumbent subset at fleet-command N7s remains an open research item for a future find_sources pass narrowed to FLTFORCOM N7 / COMPACFLT N7 / INDOPACOM J7 contracting offices.
...
**FACT:** Invictus Associates LLC holds the Navy delivery order PIID N0016424F3006 against parent IDC N0017819D7883 for Professional Support Services — Fleet Readiness Support for CNRMC, subordinate RMCs, and Surface Team One; total obligation $19,384,385; Norfolk, VA place of performance; Department of Defense (Department of the Navy sub-tier) funder [s.2026-05-26-professional-support-services-].
...
**Assessment:** USAspending records surface tens-of-millions-of-dollars contractor activity around NSWC Carderock work-types (acoustic-signature trials, signature-training-systems development, Carderock engineering services, NSWCCD Code 70 scientific and programmatic support). Specific contractor names and obligation amounts are intentionally not asserted here because the underlying USAspending records were never deep-fetched and ingested as primary sources during the 2026-05-26 pass. The named-entity discipline (`_meta/feedback_named_contractor_discipline.md`) prohibits introducing named contractors into analytical content without ingested-source backing. The Carderock landscape is included here only as environmental context for the §6.3 HM&E-data-bridge decision; if specific contractor names need to inform the brief, the underlying USAspending awards should be deep-fetched and ingested first, with citations added then.

**Assessment:** SAIC and Leidos are operator-allowlisted (per `_entity-allowlist.yaml`) as canonical naval-services incumbents. Their Carderock contract footprint, if any, would confirm Navy-services access but does NOT establish direct competition for the corrected-scope sub-product; the specific Carderock contracts were not deep-fetched in the 2026-05-26 pass, so the §5.5 framing tracks them as environmental-context candidates rather than confirmed Carderock contractors. Under the 2026-05-26 scope correction, Carderock is the source for survivability modeling that may feed scenario content, not a customer for the scenario content itself. These incumbents are tracked here as environmental context; their conversion to direct competitive threat under the corrected scope depends on their identifying the same fleet-command exercise-planning procurement pathway §5.3 names and pivoting capability into it.
...
**FACT:** CACI NSS, LLC is a CACI subsidiary that holds three governmentwide acquisition contracts open to any federal customer:
- A GSA Federal Acquisition Service multiple-award IDC (parent PIID GS00Q14OADU121), confirmed via the AFRICOM task order record [s.2026-05-26-the-purpose-of-this-award-is-t].
- A NITAAC CIO-SP3 contract (parent PIID HHSN316201200032W), confirmed via a CACI NSS task order record (PIID 19AQMM21F1762, $101.2 million obligation, Iterative Software Development Project Management scope) [s.2026-05-27-iterative-software-development].
- A GSA Multiple Award Schedule contract (GS-35F-349CA, period of performance 2 June 2015 through 1 June 2030, with one five-year option), confirmed via the GSA eLibrary contractor information record [s.2026-05-27-gsa-elibrary-contractor-inform].

**Assessment:** The GSA Federal Acquisition Service multiple-award IDC at PIID GS00Q14OADU121 is GSA OASIS Pool 1. The three vehicles together — OASIS Pool 1, NITAAC CIO-SP3, and GSA MAS — give CACI NSS, LLC direct task-order access from any federal customer (including any Navy fleet command) without requiring a new Navy-specific contracting action.

**FACT:** CACI NSS, LLC holds task order PIID 47QFCA20F0002 against parent IDC GS00Q14OADU121 for *"Plans, Operations, Logistics, Engagement, Training, Exercise, and Assessment Support to AFRICOM"* — total obligation $194,034,792, Department of the Army funder via GSA Federal Acquisition Service [s.2026-05-26-the-purpose-of-this-award-is-t].

**Assessment:** Parent IDC GS00Q14OADU121 is GSA OASIS Pool 1, the governmentwide acquisition contract that gives CACI NSS, LLC direct task-order access for any federal customer including any Navy fleet command. The vehicle's status as an OASIS Pool 1 contract is the procurement-infrastructure asset the right-to-win argument rests on.
...
**Assessment (HM&E bridge — analyst recommendation and ownership of the decision, recorded 2026-05-28).** The HM&E-bridge path-selection decision belongs to the executive engaged with the customer or to the proposal team that drafts the actual response — not to the BD analyst building the capture, and not to the vault. The analyst's recommendation, recorded here for downstream reference, is the NSWC Carderock GFI path: negotiate Government Furnished Information from Carderock as part of any contract that procures the sub-product, treat the 12-to-18-month Authority-to-Operate risk as a known schedule item, and avoid the teaming-with-HM&E-prime path because it both narrows CACI's prime position and forces an early commit to a specific partner before customer pull is known. The CACI internal-naval-IT path remains a viable fallback if the GFI negotiation stalls. None of the three paths becomes a FACT in the vault — each is a scoping option the executive or proposal team will commit to with full strategic context. The brief should reflect this ownership distinction in §5.3: the bridge decision is named, the candidate paths are named, the analyst's recommendation is named, and the actual commit is explicitly downstream of the brief.
...
- [s.2026-05-27-not-for-publication-until-rele] https://www.defense.gov/News/Transcripts/Transcript/Article/3773172/not-for-publication-until-released-by-the-house-armed-services-committee-statement-of-admi/  →  `01_sources/2026-05-27_defense-gov_not-for-publication-until-released-by-the-house-armed-servic.md`
- [s.2026-05-27-dvids-news-uss-ashland-complet] https://www.dvidshub.net/news/561986/uss-ashland-completes-ship-wartime-repair-and-maintenance-exercise-philippines  →  `01_sources/2026-05-27_dvidshub-net_dvids-news-uss-ashland-completes-ship-wartime-repair-and-mai.md`
- [s.2026-05-27-uss-pinckney-departs-singapore] https://www.navy.mil/Press-Office/News-Stories/display-news/Article/4403587/uss-pinckney-departs-singapore-after-ship-repair-and-maintenance-exercise/  →  `01_sources/2026-05-27_navy-mil_uss-pinckney-departs-singapore-after-ship-repair-and-mainten.md`
- [s.2026-05-27-readout-of-the-secretary-of-th] https://www.globalsecurity.org/military/library/news/2025/05/mil-250514-usnpr01.htm  →  `01_sources/2026-05-27_globalsecurity-org_readout-of-the-secretary-of-the-navy-john-c-phelan-s-testimo.md`
- [s.2026-05-27-gsa-elibrary-contractor-inform] https://www.gsaelibrary.gsa.gov/ElibMain/contractorInfo.do?contractNumber=GS-35F-349CA&contractorName=CACI+NSS%2C+LLC&executeQuery=YES  →  `01_sources/2026-05-27_gsaelibrary-gsa-gov_gsa-elibrary-contractor-information.md`
- [s.2026-05-27-iterative-software-development] https://www.usaspending.gov/award/CONT_AWD_19AQMM21F1762_1900_HHSN316201200032W_7529/  →  `01_sources/2026-05-27_usaspending-gov_iterative-software-development-project-management.md`
- [s.2026-05-28-u-s-navy-awards-saic-120-milli] https://investors.saic.com/news-releases/news-release-details/us-navy-awards-saic-120-million-contract-tactical-training-war  →  `01_sources/2026-05-28_investors-saic-com_u-s-navy-awards-saic-120-million-contract-for-tactical-train.md`
- [s.2026-05-28-hii-selected-for-u-s-navy-trai] https://www.hii.com/news/hii-selected-for-u-s-navy-training-contract-to-enhance-readiness  →  `01_sources/2026-05-28_hii-com_hii-selected-for-u-s-navy-training-contract-to-enhance-readi.md`
- [s.2026-05-28-building-defense-technology-fo] https://www.boozallen.com/markets/defense/accelerate-decision-advantage-in-the-indo-pacific.html  →  `01_sources/2026-05-28_boozallen-com_building-defense-technology-for-the-indo-pacific.md`
