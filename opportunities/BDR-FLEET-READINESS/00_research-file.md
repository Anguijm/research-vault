...
### 5.1 Cross-customer Exercise / Wargames / Decision-Support incumbents — the procurement-pathway prototype

The three large non-Navy federal contracts surfaced at §3.6 establish the work-type at federal scale and tell §5 what kind of Navy-equivalent named vehicle and incumbent set to expect.

**FACT:** CACI NSS LLC holds a $194 million contract for *"Plans, Operations, Logistics, Engagement, Training, Exercise, and Assessment Support to AFRICOM"* — Department of Defense / Department of the Army funder, General Services Administration awarder [s.2026-05-26-the-purpose-of-this-award-is-t].

**FACT:** Parsons Government Services Inc. holds a $556.8 million CEOIS task order providing near real-time situational awareness and decision support to the Department of Defense Combatant Commands — Office of the Secretary of Defense funder via GSA [s.2026-05-26-the-purpose-of-this-award-is-f].

**FACT:** Axient LLC holds a $233.8 million Test, Exercise and Wargames Support contract — Missile Defense Agency funder [s.2026-05-26-test-exercise-and-wargames-sup].

**Assessment.** CACI itself is the dominant incumbent in this layer via NSS LLC. That is the right-to-win lineage that §6 (Our fit) develops. Parsons and Axient are evidence the work-type is procured at the multi-hundred-million-dollar scale across multiple federal customers — they are not direct competitors for the corrected-scope sub-product at the Navy repair-activity level, but they are the procurement-pathway prototypes that establish what kind of Navy vehicle the §5 investigation has to hunt for.
...
### 6.1 Existing federal contract footprint in the corrected-scope work-type

CACI is already executing exercise-design / operations-support / training / assessment work at multi-hundred-million-dollar scale at a sister combatant command — that is the direct right-to-win lineage for the corrected-scope product.

**FACT:** CACI NSS LLC holds a delivery order (PIID 47QFCA20F0002) against parent IDC GS00Q14OADU121 for *"Plans, Operations, Logistics, Engagement, Training, Exercise, and Assessment Support to AFRICOM"* — total obligation $194,034,792, Department of the Navy [sic, per the USAspending source — funder is Army, awarder is GSA Federal Acquisition Service] [s.2026-05-26-the-purpose-of-this-award-is-t].

**FACT:** The AFRICOM contract scope covers the full work-type stack named in the corrected-scope product description: plans, operations, logistics, engagement, training, exercise, and assessment support [s.2026-05-26-the-purpose-of-this-award-is-t].

**Assessment.** CACI NSS LLC's AFRICOM contract is the single most consequential right-to-win artifact in this research. It demonstrates CACI has been executing the exact work-type at multi-hundred-million-dollar scale to a Combatant Command customer since 2020. The work-type translates directly to the corrected-scope product: AFRICOM's combatant-command exercise support is structurally similar to fleet-command exercise support (which §5.3 names as the most-likely procurement layer for the corrected scope). The Navy fleet-command equivalents — FLTFORCOM, COMPACFLT, INDOPACOM J7 — buy a similar shape of work; the gap is identifying the specific named-vehicle that maps the AFRICOM-style contracting pattern onto the Navy fleet-command structure. Note that the funder of the CACI NSS contract is Army (via GSA) supporting an AFRICOM customer; the precedent for CACI to execute a similar arrangement with a Navy fleet-command customer through a different agency funder is already established.
...
Position CACI as a candidate prime for the corrected-scope sub-product (1-hour turn-based gamified decision-rehearsal sessions for BDAR / BDAT staff-cell and wardroom audiences) on a two-layer customer-procurement model: **SRF-JRMC as the most-likely end-user / sponsor**, and **PACFLT N7 / N4 or FLTFORCOM N7 / N4 as the most-likely contracting authority** with the right budget color (OPN, RDT&E, or O&M depending on procurement structure). SRF-JRMC operationally needs the sub-product and is the named demand signal but does not directly hold the RDT&E / OPN budget authority required for a net-new gamified software platform; the contracting pathway runs through Fleet (PACFLT / FLTFORCOM N7 N4) or, alternatively, through DIU / SBIR / STTR for an initial pilot. The recommendation leverages the CACI NSS LLC AFRICOM contract as procurement-pathway prototype and the PMTEC INDOPACOM J7 work as applied capability lineage. The ARKA signature-library asset is the threat-environment differentiator; the repair-side realism gap (HM&E, logistics, drydock data) needs a bridge through partnering with an HM&E-data-holding prime, leveraging CACI's existing naval-IT footprint, or negotiating GFI as part of any sub-product procurement. Initial entry is most likely as a subcontractor on an existing fleet-command exercise-planning vehicle, with the path to prime contingent on either a new fleet-command procurement vehicle that names the sub-product specifically or a SBIR / STTR / DIU pilot that establishes scale and references. The §11 engagement strategy will sequence the relationship-development work in parallel with the disconfirming-evidence checks in §10.
