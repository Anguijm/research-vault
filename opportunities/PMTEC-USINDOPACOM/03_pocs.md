...
# PMTEC-USINDOPACOM — POC Directory

Re-verify all entries every 90 days. Defense roles rotate. **Next review due: 2026-08-08.**
...
- **Brent Parker** is the working-level industry intake; **Maj. Tuan Nguyen (J83)** is the formal intake channel. Engage both.
- **Larry Jordan** at DIU / OnRamp Hub: Hawaii is the warm-intro path — particularly relevant for positioning CACI post-ARKA as a non-traditional.
- **Andy Emslie** and **Daniel Hannah** should be co-engaged on the SDA PWSA / space integration play.
- **Dave Bednarcik** is the primary POC for the C-UAS adversary target and maritime target gap (white paper addressee).
- **Mary Ann Swendsen** leads AI, digital twin, and information security for experimentation — key for ARKA agentic-AI play.
- All "Source URL" entries point to public .mil or government sources. Verify email for Parker is still active before using — .ctr addresses expire.
- Single-sourced caveat: role assignments for Emslie, Matsunaka, Hall, and Bednarcik are sourced from PMTEC industry engagement materials. Re-verify against a second primary source before external use.
