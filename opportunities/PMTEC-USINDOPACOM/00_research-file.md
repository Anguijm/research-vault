...
**FACT:** `[✗ UNSUPPORTED]` The FY26 PDI book funds PMTEC across three service components within the "Exercises, Training, Experimentation, and Innovation" PDI category [s.2026-05-12-fy2026-pacific-deterrence-init]:
...
**FACT:** `[✗ UNSUPPORTED]` Johns Hopkins APL is publicly named as a PMTEC partner. The January 2026 Indo-Pacific Defense FORUM article *"PMTEC pioneers AI-enabled warfare capabilities"* documents APL's role in PMTEC's AI/digital-twin research [s.2026-05-12-pmtec-pioneers-ai-enabled-warf].
