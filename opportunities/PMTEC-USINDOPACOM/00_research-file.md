...
6. **Realistic training targets** — Dave Bednarcik (range and targets PM) identified a specific need for industry support in developing more realistic targets, surfaced via Cobra Gold 2026 (Feb 24 – Mar 6). *Cross-link (added 2026-05-21): [[../BDR-FLEET-READINESS/index|BDR-FLEET-READINESS]] research track examines whether NSWC Carderock BDR / ship-survivability modeling could inform realism on the naval-damage side of training scenarios; if that track's hypothesis survives disconfirming checks, this PMTEC priority and that track may converge on a joint Navy-side recommendation.*
