...
title: SRF-JRMC askSage governance instruction — rewrite v0.8
status: draft v0.8 (authority basis stated durably in §2 — no volatile contract identifiers; B/C pending working group)
...
prior_version: 03_instruction/instruction-v0.7.md
...
**SRF-JRMC INSTRUCTION 5239.1 [DRAFT — REWRITE v0.8]**
...
*End of draft v0.8. Prior versions retained at instruction-v0.1.md … v0.7.md;
