...
title: SRF-JRMC askSage governance instruction — rewrite v0.9
status: draft v0.9 (departmental information-governance plans added as a pre-access gate; B/C pending working group)
...
prior_version: 03_instruction/instruction-v0.8.md
...
**SRF-JRMC INSTRUCTION 5239.1 [DRAFT — REWRITE v0.9]**
...
*End of draft v0.9. Prior versions retained at instruction-v0.1.md … v0.8.md;
