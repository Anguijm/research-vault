...
title: SRF-JRMC askSage governance instruction — rewrite v0.5
status: draft v0.5 (real department structure embedded; AI changes no existing process; federated KB; B/C pending working group)
...
prior_version: 03_instruction/instruction-v0.4.md
...
This is a **command-standalone askSage instance at Impact Level 5**, built to a
**best-in-class** maturity target. v0.5 embeds the command's real department structure
...
**SRF-JRMC INSTRUCTION 5239.1 [DRAFT — REWRITE v0.5]**
...
- **Efficiency.** Indexing large references once at the repository level (Section 5) and a
  shared, vetted prompt library reduce waste.

---

*End of draft v0.5. Prior versions retained at instruction-v0.1.md … v0.4.md;
